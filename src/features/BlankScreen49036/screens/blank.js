...
export class _Blank extends React.Component {
  ...
  state = {
    ...
    CheckBox_21: true,
    Radio_23: true,
    Datepicker_14: new Date("07/17/2020")
  }
      ...
      >
        ...
        >
          ...
          <Toggle
            ...
            checked={this.state.Toggle_16}
            onChange={nextChecked => this.setState({ Toggle_16: nextChecked })}
          />
          <CheckBox
            text="Checkbox"
            disabled={false}
        ...
        >
          ...
          <Datepicker
            ...
            date={this.state.Datepicker_14}
            onSelect={nextValue => this.setState({ Datepicker_14: nextValue })}
          />
          <Slider
            value={50}
            minimumValue={0}
